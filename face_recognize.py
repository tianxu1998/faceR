...
def main():
    dududu = face_rec()
    print("dududu的类型" + str(type(dududu)))
    path = "D:/face/keras-face-recognition-master/face_dataset/19001010302.JPG"
    draw = utils.convert_img(path)
    dududu.recognize(draw)
    utils.save_image("./test.jpg", draw) # 保存图片到指定路径
